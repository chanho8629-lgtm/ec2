...
> 현재 등록된 것은 **시연 영상이 아니라 영상 촬영용 가이드**입니다.

| 시간 | 시연 화면 | 확인할 기술 |
|---|---|---|
| 0:00–1:30 | 작품 등록 | S3 저장, 태그·예술관 관계 저장 |
| 1:30–2:10 | 예술관 상세·수정 | 작품 연결과 연관 데이터 처리 |
| 2:10–3:10 | 경매 입찰 | `SELECT FOR UPDATE`, 최고 입찰 유일 제약 |
| 3:10–4:00 | Bootpay 결제 | 서버 영수증 검증, 중복 결제 차단 |
| 4:00–4:40 | AI 기능 | 예측·분류·유사도 추천·경매 RAG |
| 4:40–5:00 | GitHub Actions | Java 28개·FastAPI 3개 테스트 |

### [▶ 상세 시연 가이드 바로 보기](docs/portfolio/DEMO_GUIDE.md)

### 빠른 탐색

[주요 기능](#-주요-기능) · [플로우차트](#bideo-시스템-플로우차트) · [AI 근거](#-데이터-분석--ai-근거-자료) · [ERD](#️-erd--데이터-모델) · [트러블슈팅](#-트러블슈팅) · [검증 현황](#-검증-현황) · [5분 시연 가이드](docs/portfolio/DEMO_GUIDE.md)
